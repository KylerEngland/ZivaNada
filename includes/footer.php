            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="https://www.facebook.com/ZivaNadaSplit" target="_blank">
                ...
                <?php else: ?>
                    <div class="small text-center text-muted fst-italic">
                        <a href="loginPage.php">Admin prijava</a>
                    </div>
                <?php endif; ?>
                <div class="small text-center text-muted fst-italic"><a href="credits.php">Izvori</a></div>
            </div>
        </div>
    </div>
</footer>