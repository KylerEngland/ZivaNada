            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <div class="row credits">
                    <div class="col-sm">
                        ...
                        <p>Devotion icons created by Freepik - Flaticon</p>
                    ...
                    <div class="col-sm">
                        <img src="../assets/img/Values/bible.png" alt="" class="img-fluid mb-4 mb-lg-0"
                            style="height:25%; width:auto;">
                        <p>Church icons created by Freepik - Flaticon</p>
                    ...
                    <div class="col-sm">
                        <img src="../assets/img/Values/evangelize.png" alt="" class="img-fluid mb-4 mb-lg-0"
                            style="height:25%; width:auto;">
                        <p>Speak icons created by Voysla - Flaticon</p>
                    ...
                    <div class="col-sm">
                        <img src="../assets/img/Values/acceptance3.png" alt="" class="img-fluid mb-4 mb-lg-0"
                            style="height:25%; width:auto;">
                        <p>Hug icons created by Irakun - Flaticon</p>
                ...
                <div class="d-flex justify-content-begin mb-4">
                    <h2 class="post-title">Background Images</h2>
                </div>
