            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="d-flex justify-content-begin mb-4">
                        <h2 class="post-title">Find Us</h2>
                    </div>
                    <div id="map" class="d-flex justify-content-begin mb-4">
                        <script>
                            ...
                            thirdParking.bindPopup("<p>If you want, you can park in the parking garage next to McDonald's. From there it is very easy to walk on the left side of the building, so the church is then immediately to the right.</p><br><a href='https://maps.app.goo.gl/kXJfxFvFa3BSRwcJ8' target='_blank'>Google karta</a>");
