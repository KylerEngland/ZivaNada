        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == TRUE):?>
                    <div class="small text-center text-muted fst-italic"><a href="pages/profile.php">Profil</a></div>
                <?php else: ?>
                    <div class="small text-center text-muted fst-italic"><a href="pages/loginPage.php">Admin prijava</a></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
